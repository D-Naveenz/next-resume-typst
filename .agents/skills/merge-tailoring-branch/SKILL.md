...
description: Safely hand off reusable improvements from this repository's private tailoring branches into development. Use when Codex needs to review, merge, cherry-pick, or port changes from branches named tailoring/*, such as tailoring/Naveen, while preventing person-specific resume data, profile assets, employer/school details, generated private PDFs, or other tailoring content from leaking into development.
---
...
```powershell
python .codex\skills\merge-tailoring-branch\scripts\tailoring_merge_report.py --base development --tailoring tailoring/<name>
```
